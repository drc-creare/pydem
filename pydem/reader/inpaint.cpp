...
#define __PYX_HAVE__pydem__reader__inpaint
#define __PYX_HAVE_API__pydem__reader__inpaint
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* "pydem/reader/inpaint.pyx":26
 * 
 * DTYPEf = np.float32
 * ctypedef np.float32_t DTYPEf_t             # <<<<<<<<<<<<<<
 * 
 * #ctypedef fused DTYPEi:
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_5pydem_6reader_7inpaint_DTYPEf_t;

/* "pydem/reader/inpaint.pyx":36
 * #    np.int64_t
 * 
 ...
 */
typedef __pyx_t_5numpy_int64_t __pyx_t_5pydem_6reader_7inpaint_DTYPEi_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'pydem.reader.inpaint' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEf_t = { "DTYPEf_t", NULL, sizeof(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEi_t = { "DTYPEi_t", NULL, sizeof(__pyx_t_5pydem_6reader_7inpaint_DTYPEi_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5pydem_6reader_7inpaint_DTYPEi_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5pydem_6reader_7inpaint_DTYPEi_t), 0 };
#define __Pyx_MODULE_NAME "pydem.reader.inpaint"
int __pyx_module_is_main_pydem__reader__inpaint = 0;

/* Implementation of 'pydem.reader.inpaint' */
...
static char __pyx_k_pydem_reader_inpaint[] = "pydem.reader.inpaint";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_Copyright_2015_Creare_Licensed[] = "\n   Copyright 2015 Creare\n\n   Licensed under the Apache License, Version 2.0 (the \"License\");\n   you may not use this file except in compliance with the License.\n   You may obtain a copy of the License at\n\n       http://www.apache.org/licenses/LICENSE-2.0\n\n   Unless required by applicable law or agreed to in writing, software\n   distributed under the License is distributed on an \"AS IS\" BASIS,\n   WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n   See the License for the specific language governing permissions and\n   limitations under the License.\n\nA module for various utilities and helper functions\n\n";
static char __pyx_k_home_ubuntu_pydem_pydem_reader[] = "/home/ubuntu/pydem/pydem/reader/inpaint.pyx";
...
static PyObject *__pyx_kp_s_home_ubuntu_pydem_pydem_reader;
static PyObject *__pyx_n_s_i;
...
static PyObject *__pyx_n_s_pydem_reader_inpaint;
...
static PyObject *__pyx_pf_5pydem_6reader_7inpaint_replace_nans(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_array, int __pyx_v_max_iter, float __pyx_v_tol, int __pyx_v_kernel_size, PyObject *__pyx_v_method); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_5pydem_6reader_7inpaint_1replace_nans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5pydem_6reader_7inpaint_replace_nans[] = "Replace NaN elements in an array using an iterative image inpainting algorithm.\n\n    The algorithm is the following:\n\n    1) For each element in the input array, replace it by a weighted average\n       of the neighbouring elements which are not NaN themselves. The weights depends\n       of the method type. If ``method=localmean`` weight are equal to 1/( (2*kernel_size+1)**2 -1 )\n\n    2) Several iterations are needed if there are adjacent NaN elements.\n       If this is the case, information is \"spread\" from the edges of the missing\n       regions iteratively, until the variation is below a certain threshold.\n\n    Parameters\n    ----------\n\n    array : 2d np.ndarray\n        an array containing NaN elements that have to be replaced\n\n    max_iter : int\n        the number of iterations\n\n    kernel_size : int\n        the size of the kernel, default is 1\n\n    method : str\n        the method used to replace invalid values. Valid options are\n        `localmean`.\n\n    Returns\n    -------\n\n    filled : 2d np.ndarray\n        a copy of the input array, where NaN elements have been replaced.\n\n    ";
static PyMethodDef __pyx_mdef_5pydem_6reader_7inpaint_1replace_nans = {"replace_nans", (PyCFunction)__pyx_pw_5pydem_6reader_7inpaint_1replace_nans, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pydem_6reader_7inpaint_replace_nans};
static PyObject *__pyx_pw_5pydem_6reader_7inpaint_1replace_nans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_iter)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 3, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 3, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "replace_nans") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 3, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pydem.reader.inpaint.replace_nans", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_5pydem_6reader_7inpaint_replace_nans(__pyx_self, __pyx_v_array, __pyx_v_max_iter, __pyx_v_tol, __pyx_v_kernel_size, __pyx_v_method);
...
static PyObject *__pyx_pf_5pydem_6reader_7inpaint_replace_nans(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_array, int __pyx_v_max_iter, float __pyx_v_tol, int __pyx_v_kernel_size, PyObject *__pyx_v_method) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_I;
  int __pyx_v_J;
  ...
  __pyx_t_5pydem_6reader_7inpaint_DTYPEf_t __pyx_t_53;
  ...
  __pyx_pybuffernd_array.rcbuffer = &__pyx_pybuffer_array;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_array.rcbuffer->pybuffer, (PyObject*)__pyx_v_array, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_array->dimensions[0])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_array->dimensions[1])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyList_New(2); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPEf); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_filled.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_empty); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_long(((2 * __pyx_v_kernel_size) + 1)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_long(((2 * __pyx_v_kernel_size) + 1)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_kernel.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_nonzero); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_isnan); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (!__pyx_t_4) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_7, ((PyObject *)__pyx_v_array)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  } else {
    ...
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_8, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  if ((likely(PyTuple_CheckExact(__pyx_t_1))) || (PyList_CheckExact(__pyx_t_1))) {
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_8 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    #endif
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  } else {
    Py_ssize_t index = -1;
    __pyx_t_2 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_IternextUnpackEndCheck(__pyx_t_9(__pyx_t_2), 2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_9 = NULL;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_10 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_inans.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_11 < 0)) {
      PyErr_Fetch(&__pyx_t_12, &__pyx_t_13, &__pyx_t_14);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_inans.rcbuffer->pybuffer, (PyObject*)__pyx_v_inans, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_15 = ((PyArrayObject *)__pyx_t_8);
  {
    ...
    __pyx_t_11 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer, (PyObject*)__pyx_t_15, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_11 < 0)) {
      PyErr_Fetch(&__pyx_t_14, &__pyx_t_13, &__pyx_t_12);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer, (PyObject*)__pyx_v_jnans, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  __pyx_t_16 = PyObject_Length(((PyObject *)__pyx_v_inans)); if (unlikely(__pyx_t_16 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_n_nans = __pyx_t_16;

  /* "pydem/reader/inpaint.pyx":93
 * 
 *     # arrays which contain replaced values to check for convergence
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_n_nans); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPEf); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_replaced_new.rcbuffer->pybuffer, (PyObject*)__pyx_t_17, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_n_nans); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPEf); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_replaced_old.rcbuffer->pybuffer, (PyObject*)__pyx_t_18, &__Pyx_TypeInfo_nn___pyx_t_5pydem_6reader_7inpaint_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  __pyx_t_19 = (__Pyx_PyString_Equals(__pyx_v_method, __pyx_n_s_localmean, Py_EQ)); if (unlikely(__pyx_t_19 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_20 = (__pyx_t_19 != 0);
  if (__pyx_t_20) {

    /* "pydem/reader/inpaint.pyx":98
 *     # depending on kernel type, fill kernel array
 *     if method == 'localmean':
 *         for i in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 *             for j in range(2*kernel_size+1):
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_25, __pyx_pybuffernd_kernel.diminfo[1].strides) = 1.0;
      }
    }
 ...
 */
  /*else*/ {
    __pyx_t_8 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_31, __pyx_pybuffernd_filled.diminfo[1].strides) = (*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_array.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_array.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_array.diminfo[1].strides));
    }
  }

  /* "pydem/reader/inpaint.pyx":111
 *     # make several passes
 ...
 */
      ...
      __pyx_v_i = (*__Pyx_BufPtrStrided1d(__pyx_t_5pydem_6reader_7inpaint_DTYPEi_t *, __pyx_pybuffernd_inans.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_inans.diminfo[0].strides));

      /* "pydem/reader/inpaint.pyx":116
 *         for k in range(n_nans):
 *             i = inans[k]
 *             j = jnans[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_j = (*__Pyx_BufPtrStrided1d(__pyx_t_5pydem_6reader_7inpaint_DTYPEi_t *, __pyx_pybuffernd_jnans.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_jnans.diminfo[0].strides));

      /* "pydem/reader/inpaint.pyx":119
 * 
 *             # initialize to zero
 *             filled[i,j] = 0.0             # <<<<<<<<<<<<<<
 *             n = 0
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_36, __pyx_pybuffernd_filled.diminfo[1].strides) = 0.0;

      /* "pydem/reader/inpaint.pyx":120
 *             # initialize to zero
 *             filled[i,j] = 0.0
 *             n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              __pyx_t_20 = (((*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_39, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_40, __pyx_pybuffernd_filled.diminfo[1].strides)) == (*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_42, __pyx_pybuffernd_filled.diminfo[1].strides))) != 0);
              if (__pyx_t_20) {

                /* "pydem/reader/inpaint.pyx":134
 * 
 *                                 # do not sum itself
 ...
 */
                  ...
                  *__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_49, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_50, __pyx_pybuffernd_filled.diminfo[1].strides) = ((*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_43, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_44, __pyx_pybuffernd_filled.diminfo[1].strides)) + ((*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_45, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_46, __pyx_pybuffernd_filled.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_47, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_48, __pyx_pybuffernd_kernel.diminfo[1].strides))));

                  /* "pydem/reader/inpaint.pyx":138
 *                                     # convolve kernel with original array
 *                                     filled[i,j] = filled[i,j] + filled[i+I-kernel_size, j+J-kernel_size]*kernel[I, J]
 *                                     n = n + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_53 = (*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_51, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_52, __pyx_pybuffernd_filled.diminfo[1].strides));
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_54, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_55, __pyx_pybuffernd_filled.diminfo[1].strides) = (__pyx_t_53 / __pyx_v_n);

        /* "pydem/reader/inpaint.pyx":143
 *             if n != 0:
 *                 filled[i,j] = filled[i,j] / n
 *                 replaced_new[k] = filled[i,j]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_58, __pyx_pybuffernd_replaced_new.diminfo[0].strides) = (*__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_56, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_57, __pyx_pybuffernd_filled.diminfo[1].strides));
 ...
 */
      /*else*/ {
        ...
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_nan); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_53 = __pyx_PyFloat_AsFloat(__pyx_t_2); if (unlikely((__pyx_t_53 == (npy_float32)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_59 = __pyx_v_i;
        __pyx_t_60 = __pyx_v_j;
        *__Pyx_BufPtrStrided2d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_filled.rcbuffer->pybuffer.buf, __pyx_t_59, __pyx_pybuffernd_filled.diminfo[0].strides, __pyx_t_60, __pyx_pybuffernd_filled.diminfo[1].strides) = __pyx_t_53;
      }
      __pyx_L32:;
    }

    /* "pydem/reader/inpaint.pyx":149
 *         # check if mean square difference between values of replaced
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_mean); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_Subtract(((PyObject *)__pyx_v_replaced_new), ((PyObject *)__pyx_v_replaced_old)); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_1 = PyNumber_Power(__pyx_t_8, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = NULL;
    if (CYTHON_COMPILING_IN_CPYTHON && unlikely(PyMethod_Check(__pyx_t_3))) {
    ...
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyFloat_FromDouble(__pyx_v_tol); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_7 = PyObject_RichCompare(__pyx_t_2, __pyx_t_3, Py_LT); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_t_7); if (unlikely(__pyx_t_20 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    if (__pyx_t_20) {

      /* "pydem/reader/inpaint.pyx":150
 *         #elements is below a certain tolerance
 *         if np.mean( (replaced_new-replaced_old)**2 ) < tol:
 *             break             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_replaced_old.rcbuffer->pybuffer.buf, __pyx_t_62, __pyx_pybuffernd_replaced_old.diminfo[0].strides) = (*__Pyx_BufPtrStrided1d(__pyx_t_5pydem_6reader_7inpaint_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_61, __pyx_pybuffernd_replaced_new.diminfo[0].strides));
      }
    }
  }
  __pyx_L15_break:;

  /* "pydem/reader/inpaint.pyx":155
 *                 replaced_old[l] = replaced_new[l]
 * 
 *     return filled             # <<<<<<<<<<<<<<
 * 
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "inpaint",
    __pyx_k_Copyright_2015_Creare_Licensed, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_ubuntu_pydem_pydem_reader, __pyx_k_home_ubuntu_pydem_pydem_reader, sizeof(__pyx_k_home_ubuntu_pydem_pydem_reader), 0, 0, 1, 0},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pydem_reader_inpaint, __pyx_k_pydem_reader_inpaint, sizeof(__pyx_k_pydem_reader_inpaint), 0, 0, 1, 1},
 ...
 *     # fill new array with input elements
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_method_not_valid_Should_be_one_o); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_tuple__8 = PyTuple_Pack(21, __pyx_n_s_array, __pyx_n_s_max_iter, __pyx_n_s_tol, __pyx_n_s_kernel_size, __pyx_n_s_method, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_I, __pyx_n_s_J, __pyx_n_s_it, __pyx_n_s_n, __pyx_n_s_k, __pyx_n_s_l, __pyx_n_s_n_invalids, __pyx_n_s_filled, __pyx_n_s_kernel, __pyx_n_s_inans, __pyx_n_s_jnans, __pyx_n_s_n_nans, __pyx_n_s_replaced_new, __pyx_n_s_replaced_old); if (unlikely(!__pyx_tuple__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(5, 0, 21, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_ubuntu_pydem_pydem_reader, __pyx_n_s_replace_nans, 40, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("inpaint", __pyx_methods, __pyx_k_Copyright_2015_Creare_Licensed, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pydem__reader__inpaint) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "pydem.reader.inpaint")) {
      if (unlikely(PyDict_SetItemString(modules, "pydem.reader.inpaint", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * DTYPEf = np.float32
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_platform, 0, -1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_platform, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pydem/reader/inpaint.pyx":25
 * import platform
 * 
 * DTYPEf = np.float32             # <<<<<<<<<<<<<<
 * ctypedef np.float32_t DTYPEf_t
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPEf, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_5pydem_6reader_7inpaint_1replace_nans, NULL, __pyx_n_s_pydem_reader_inpaint); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_replace_nans, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pydem/reader/inpaint.pyx":1
 * """             # <<<<<<<<<<<<<<
 *    Copyright 2015 Creare
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pydem.reader.inpaint", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pydem.reader.inpaint");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
